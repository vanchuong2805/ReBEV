...
export const orders = [
  ...
  // 🔹 XE MỚI – Đang chờ xác nhận lịch hẹn
...
export const order_detail = [
  ...
  // Xe -> deposit + lịch hẹn (đã hoàn tất)
...
export const order_status = [
  ...
  // 🔹 XE MỚI – chờ xác nhận lịch hẹn
  { id: 16, order_id: 9008, status: 'pending', description: 'Chờ người bán xác nhận lịch hẹn xem xe', create_at: '2025-09-28T09:00:00+07:00' },
]
