...
import Frame, { formatVND } from './ListingCardFrame'
  ...
  return (
    <Frame
      ...
      actions={[
        ...
        <Button size="lg" variant="outline" className="h-10 w-full text-red-600 border-red-200" onClick={() => onHide?.(listing)}>Ẩn tin</Button>,
      ]}
    />
  )
}
